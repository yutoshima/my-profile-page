        ...
        <div className="space-y-4">
          ...
          {socials.map((s) => (
            <Card key={s.label}>
              ...
              >
                <span className="flex items-center justify-center w-12 h-12 border rounded-full text-white/90 group-hover:text-white border-white/40 group-hover:border-white/70 transition-colors">
                  {s.icon}
                </span>
