...
interface Resume {
  ...
  education: Array<{
    ...
    startDate: string; endDate: string; gpa: string; courses: string[];
  }>;
  skills: Array<{ name: string; level: string; keywords: string[] }>;
  languages: Array<{ language: string; fluency: string }>;
  fileFormat: { pdfUrl: string; docxUrl: string; jsonUrl: string };
}

const resume: Resume = resumeData as Resume;
